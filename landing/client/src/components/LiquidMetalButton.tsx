...
export function LiquidMetalButton({ label = "ENTER TERMINAL", onClick, viewMode = "text" }: LiquidMetalButtonProps) {
        ...
        >
          ...
          >
            ...
            {viewMode === "text" && (
              <span style={{
                  ...
                  transition: "all 0.8s cubic-bezier(0.34, 1.56, 0.64, 1)",
                  transform: "scale(1)", whiteSpace: "nowrap",
          ...
          >
            <div style={{
                ...
                boxShadow: isPressed ? "inset 0px 2px 4px rgba(0,0,0,0.6), inset 0px 1px 2px rgba(0,0,0,0.4)" : "none",
          ...
          >
            <div style={{
                ...
                boxShadow: isPressed
                  ...
                  : isHovered
                    ? "0px 0px 0px 1px rgba(255,255,255,0.2), 0px 8px 16px rgba(0,0,0,0.5)"
                    : "0px 0px 0px 1px rgba(255,255,255,0.1), 0px 4px 8px rgba(0,0,0,0.3)",
                transition: "all 0.8s cubic-bezier(0.34, 1.56, 0.64, 1), box-shadow 0.15s cubic-bezier(0.4, 0, 0.2, 1)",
